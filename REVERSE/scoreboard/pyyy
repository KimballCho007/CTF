**Scoreboard第41题，Reverse第四题**
>附件下载地址：https://hackme.inndy.tw/static/pyyy.pyc

Step1:
安装uncompyle6

Step2:  
反编译 uncompyle6 -o pyyy.py pyyy.pyc
```
...
# Compiled at: 2016-06-11 10:14:31
...
Step3:
修改代码31行，修改`c = l`,得到flag：FLAG{VBXDVV4jkVVS4hVVj7NVV1heVVX1jVVh}
